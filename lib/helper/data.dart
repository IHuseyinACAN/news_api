...
List<CategoryModel> getCategories() {
  List<CategoryModel> category = []; // List tanımlaması
  CategoryModel categoryModel; // Yeni bir CategoryModel nesnesi için yer tutucu

  //1
  categoryModel = CategoryModel();
  categoryModel.categoryName = "İş Dünyası";
  ...
  category.add(categoryModel); // Listeye elemanı ekleme
  ...
  return category; // Listenin döndürülmesi
}
